...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(23), __webpack_require__(60)(module)))
...
var _CanvasBoard = __webpack_require__(70);
...
var CanvasBoard = function (_Component) {
  ...
  function CanvasBoard(props) {
    ...
    _this.startDraw = _this.startDraw.bind(_this);
    _this.draw = _this.draw.bind(_this);
    _this.stopDraw = _this.stopDraw.bind(_this);
    return _this;
  }
  ...
  _createClass(CanvasBoard, [{
    ...
    value: function addClick(x, y, dragging) {
      var xArr = this.state.clickX.concat([x]);
      var yArr = this.state.clickY.concat([y]);
      var dragArr = this.state.clickDrag.concat([dragging]);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(CanvasBoard);
...
var _mainReducer = __webpack_require__(72);
...
var addUser = function addUser(oldName, newName) {
	return {
		type: types.ADD_USER
	};
};

var guessInput = function guessInput(input) {
	return {
